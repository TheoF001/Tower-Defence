...
Light::Light(GLFWwindow* window, 
    ...
    std::cout << targetPosition.z << std::endl;*/
    ...
    //projectionMatrix = ortho(-35.0f, 35.0f, -35.0f, 35.0f, nearPlane, farPlane);
    projectionMatrix = ortho(-80.0f, 80.0f, -80.0f, 80.0f, nearPlane, farPlane);
